...
{{--                                                <img alt="image" width="50" src="{{URL('admin_assets/images/avatar/1.jpg')}}">--}}
{{--                                            </div>--}}
...
{{--                                        <div class="timeline-panel">--}}
{{--                                            <div class="media mr-2">--}}
{{--                                                <img alt="image" width="50" src="{{URL('admin_assets/images/avatar/2.jpg')}}">--}}
{{--                                            </div>--}}
{{--                                            <div class="media-body">--}}
{{--                                                <h6 class="mb-1">Dr sultads Send you Photo</h6>--}}
{{--                                                <small class="d-block">29 July 2020 - 02:26 PM</small>--}}
...
{{--                    </li>--}}
                    <li class="nav-item dropdown header-profile">
                        <a class="nav-link" href="#" role="button" data-toggle="dropdown">
                            ...
                            <img src="{{URL('/storage/avatars/users')}}/{{Auth::user()->image}}" width="20" alt=""/>
                        </a>
                        <div class="dropdown-menu dropdown-menu-right">
                            <a href="{{ URL('/account/hospital/profile') }}" class="dropdown-item ai-icon">
