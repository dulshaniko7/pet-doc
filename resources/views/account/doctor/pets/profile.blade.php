...
<link href="{{URL('admin_assets/vendor/owl-carousel/owl.carousel.css')}}" rel="stylesheet">
@endsection
                            ...
                            <div class="card-body">
                                <div class="assigned-doctor owl-carousel">
                                    <div class="items">
                                        <div class="bootstrap-media">
                                            <div class="media mb-4">
                                                <img class="mr-3 img-fluid rounded" width="94" src="{{URL('admin_assets/images/avatar/1.jpg')}}" alt="DexignZone">
                                                <div class="media-body">
                                    ...
                                    <div class="items">
                                        <div class="bootstrap-media">
                                            <div class="media mb-4">
                                                <img class="mr-3 img-fluid rounded" width="94" src="{{URL('admin_assets/images/avatar/2.jpg')}}" alt="DexignZone">
                                                <div class="media-body">
                                    ...
                                    <div class="items">
                                        <div class="bootstrap-media">
                                            <div class="media mb-4">
                                                <img class="mr-3 img-fluid rounded" width="94" src="{{URL('admin_assets/images/avatar/3.jpg')}}" alt="DexignZone">
                                                <div class="media-body">
                                                    <h4 class="mt-0 mb-1 text-black">Dr. Samantha</h4>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="patient-map-area mb-4">
                                    <img src="{{URL('admin_assets/images/map.jpg')}}" alt=""/>
...
<script src="{{URL('admin_assets/vendor/owl-carousel/owl.carousel.js')}}"></script>

	<!-- Chart piety plugin files -->
	<script src="{{URL('admin_assets/vendor/peity/jquery.peity.min.js')}}"></script>
	    <script src="{{URL('admin_assets/js/plugins-init/piety-init.js')}}"></script>
