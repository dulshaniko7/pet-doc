                                ...
                                <div class="table-responsive ">
                                    <table class="table patient-activity">
                                        <tr>
                                            <td>
                                                <div class="media align-items-center">
                                                    <img class="mr-3 img-fluid rounded" width="78" src="{{URL('admin_assets/images/avatar/1.jpg')}}" alt="DexignZone">
                                        ...
                                        <tr>
                                            <td>
                                                <div class="media align-items-center">
                                                    <img class="mr-3 img-fluid rounded" width="78" src="{{URL('admin_assets/images/avatar/2.jpg')}}" alt="DexignZone">
                                                    <div class="media-body">
                                        ...
                                        <tr class="active">
                                            <td>
                                                <div class="media align-items-center">
                                                    <img class="mr-3 img-fluid rounded" width="78" src="{{URL('admin_assets/images/avatar/3.jpg')}}" alt="DexignZone">
                                                    <div class="media-body">
                                        ...
                                        <tr>
                                            <td>
                                                <div class="media align-items-center">
                                                    <img class="mr-3 img-fluid rounded" width="78" src="{{URL('admin_assets/images/avatar/4.jpg')}}" alt="DexignZone">
                                                    <div class="media-body">
                                        ...
                                        <tr>
                                            <td>
                                                <div class="media align-items-center">
                                                    <img class="mr-3 img-fluid rounded" width="78" src="{{URL('admin_assets/images/avatar/5.jpg')}}" alt="DexignZone">
                                                    <div class="media-body">
                                        ...
                                        <tr>
                                            <td>
                                                <div class="media align-items-center">
                                                    <img class="mr-3 img-fluid rounded" width="78" src="{{URL('admin_assets/images/avatar/6.jpg')}}" alt="DexignZone">
                                                    <div class="media-body">
                            ...
                            <div class="card-body  p-4">
                                <div class="media">
                                    ...
                                    <div class="media-body text-white text-right">
                                        ...
                                        <h3 class="text-white">{{$totalApp ?? ''}}</h3>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="widget-stat card bg-info">
                            <div class="card-body p-4">
                                <div class="media">
                                    ...
                                    <div class="media-body text-white text-right">
                                        <p class="mb-1">Total Pets</p>
                                        <h3 class="text-white">{{$totalPets ?? ''}}</h3>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body  p-4">
                                <div class="media">
                                    ...
                                    <div class="media-body text-white text-right">
                                        ...
                                        <h3 class="text-white">{{$totalHos ?? ''}}</h3>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body  p-4">
                                <div class="media">
                                    ...
                                    <div class="media-body text-white text-right">
                                        ...
                                        <h3 class="text-white">{{$totalDoc ?? ''}}</h3>
                                    </div>
                                </div>
                            </div>
                        </div>
