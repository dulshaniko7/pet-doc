                    ...
                    <div class="col-sm-12 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <div class="col-md-12">
                                ...
                                <div class="container">
                                    <div class="avatar-upload">
                                        ...
                                        <div class="avatar-preview">
                                            <div id="imagePreview" class="preview-div" style="background-image: url({{URL('/admin_assets/images/avatar/hospital.svg')}});">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <fieldset disabled>
                                <div class="form-group">
                                    <label>ID</label>
                                    <input type="text" class="form-control" id="petdoc_id" name="petdoc_id" value="{{$hos_petdoc_id}}">
                                </div>
                            </fieldset>
                            <input type="hidden" name="petdoc_id" value="{{$hos_petdoc_id}}">
                            <div class="form-group">
                                <label>Name</label>
                            ...
                            <div class="form-group">
                                <label>Email</label>
                                <input type="text" class="form-control" id="email" name="email" required onchange="validateEmail()">
                            </div>
...
@section('scripts')
    ...
    <script>
        ...
        $('#HospitalAddForm').on('submit', function(event) {
            ...
            $.ajax({
                url: "{{url('/account/admin/hospital/save')}}",
                method: "POST",
