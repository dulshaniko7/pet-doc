        ...
        <div class="container-fluid">
            <div class="form-head mb-md-5 mb-3 align-items-start" style="text-align: right;">
                @if($appointment->status_id == 1)
                    ...
                    <a href="javascript:void(0);" class="btn btn-success ml-2" onclick="changeStatus(4,{{$appointment->id}})"><i class="flaticon-381-success-2"></i> Accept</a>
                @endif
                                ...
                                <div class="card-body">
                                    <div class="d-flex doctor-info-details mb-5">
                                        <div class="media align-self-start">
                                            @if($appointment->pets->image)
                                                <img alt="image" class="rounded" width="130" src="{{URL('storage/pets')}}/{{$appointment->pets->image}}">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="iconbox">
                                        ...
                                        <small>Phone</small>
                                        <p>{{$appointment->pet_owner->telephone  ??''}}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                success: function(response) {
                    if (response.success) {
                        $.confirm({
                            ...
                            buttons: {
                                ok: function() {
                                    location.href = "{{URL('/account/hospital/appointments')}}";
                                }
                            }
                        });
                    }
