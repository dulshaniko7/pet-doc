...
{{--                                            <td>{{$appointment->owner->display_name}}</td>--}}
                                            ...
                                            <td>
                                                    <span class="@if($appointment->status->type == "pending")badge light badge-warning
                                                        ...
                                                        badge light badge-danger @elseif($appointment->status->type == "payment-pending")badge light badge-secondary @endif">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right">
                                                        @if($appointment->status_id == 1)
                                                            <a class="dropdown-item" href="#"
                                                               onclick="changeStatus(4,{{$appointment->id}})">Accept</a>
                                                            <a class="dropdown-item" href="#"
...
{{--                                                        @endif--}}
                                                        <a class="dropdown-item"
                                                           href="{{URL('/account/hospital/appointment')}}/{{$appointment->id}}">View
                                                            Details</a>
