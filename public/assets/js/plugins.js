...
var $slider = $(".slider"), $slideBGs = $(".slide__bg"), diff = 0, curSlide = 0, numOfSlides = $(".slide").length - 1,
    animating = !1, animTime = 500, autoSlideTimeout, autoSlideDelay = 6e3, $pagination = $(".slider-pagi");
...
!function ($) {
    function numberRoller(a) {
        var b = $(".roller-title-number-" + a).attr("data-min"), c = $(".roller-title-number-" + a).attr("data-max"),
            d = $(".roller-title-number-" + a).attr("data-delay"),
            e = $(".roller-title-number-" + a).attr("data-increment"), f = c - b, g = 1e3 * d / f;
